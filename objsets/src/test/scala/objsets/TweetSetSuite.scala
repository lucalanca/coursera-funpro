...
class TweetSetSuite extends FunSuite {
  ...
  test("most retweeted") {
    new TestSets {
      ...
      val mySet1 = (new Empty).incl(new Tweet("c", "c body", 1)).incl(new Tweet("d", "d body", 2))
      assert(mySet1.mostRetweeted.retweets == 2)

      val mySet2 = mySet1.union(set5).incl(new Tweet("f", "f body", 21))
      println(mySet2.mostRetweeted.retweets)
      assert(mySet2.mostRetweeted.retweets == 21)
    }
  }
